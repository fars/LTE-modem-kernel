...
/* This change is done to make the datapointer passed to the dma to be word
    aligned as WRIGLEY dma doesn't support nonwordaligned data pointer */
#define MAX_TCP_HEADER  (128 + MAX_HEADER + WORD_ALIGN_OFFSET)
