...
int cpcap_backup_memory_read(unsigned short *value_ptr);
void cpcap_backup_memory_write(unsigned short value, unsigned short mask);

/* use to open / close VBUS_SWITCH */
void cpcap_vbusswitch_set(unsigned short enable);
