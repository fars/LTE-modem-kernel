...
#define MAX_NUM_ECM_DEVICES 5
#elif CONFIG_USB_GADGET_DUAL_ECM
#define MAX_NUM_ECM_DEVICES 2
#else
#define MAX_NUM_ECM_DEVICES 1
#endif
#define MAC_ADDR_LEN 6

extern u8 hostaddr[MAX_NUM_ECM_DEVICES][MAC_ADDR_LEN];
...
int ecm_function_add(struct usb_composite_dev *cdev,
