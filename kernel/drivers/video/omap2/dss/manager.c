...
static struct {
	...
	struct overlay_cache_data overlay_cache[NUM_OVL];
	struct manager_cache_data manager_cache[NUM_OVL_MGR];
...
static int configure_dispc(void)
{
	...
	bool mgr_busy[NUM_OVL_MGR];
	bool mgr_go[NUM_OVL_MGR];
	bool busy;
...
int dss_init_overlay_managers(struct platform_device *pdev)
{
	...
	for (i = 0; i < NUM_OVL_MGR; ++i) {
		...
		mgr->caps = OMAP_DSS_OVL_MGR_CAP_DISPC; /* data streaming mode */
/*		mgr->caps = 0; /* Pix-by-pix mode */
