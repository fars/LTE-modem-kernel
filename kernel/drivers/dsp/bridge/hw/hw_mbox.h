 ...
 * 29-Mar-2010  Motorola Add mailbox users for W3G architecture
 */
 ...
 *! Revision History:
 *! ================
 *! 16 Jul 2009 motorola: Add new function for IRQ status
 *! 18 Mar 2009 motorola: added defines, set enum values
...
#define HW_MBOX_MAX_NUM_MAILBOXES  8
 ...
 *   Type	: const u32
 *   Description : The value of the IRQ status
 *
 * OUTPUTS:
 *
 * RETURNS:
