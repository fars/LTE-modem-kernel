...
#include <mach/board-hpm1200l-emu_uart.h>
#endif
...
#define MAX_CLK_DIV 12
#else
#define MAX_CLK_DIV 15
#endif
		...
		struct spi_transfer *t)
{
	...
	if (spi->max_speed_hz) {
		while (div <= MAX_CLK_DIV && (OMAP2_MCSPI_MAX_FREQ / (1 << div))
					> spi->max_speed_hz)
			div++;
	} else
		div = MAX_CLK_DIV;
