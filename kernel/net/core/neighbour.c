...
/*
 * Revision history
 * Motorola. Patch applied "Convert garbage collection from softirq to workqueue"
 *           Commit ID - e4c4e448cf557921ffbbbd6d6ddac81fdceacb4f in kernel.org
 */
