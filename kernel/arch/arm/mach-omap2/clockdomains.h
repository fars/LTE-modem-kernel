...
static struct clockdomain mpu_clkdm = {
	...
	.pwrdm		= { .name = "mpu_pwrdm" },
	.flags		= CLKDM_CAN_HWSUP | CLKDM_CAN_FORCE_WAKEUP,
	.clktrctrl_mask = OMAPW3G_CLKTRCTRL_MPU_MASK,
...
static struct clockdomain app_l3_clkdm = {
	.name		= "app_l3_clkdm",
	.pwrdm		= { .name = "app_pwrdm" },
	.omap_chip	= OMAP_CHIP_INIT(CHIP_IS_OMAPW3G),
};

static struct clockdomain app_l4_clkdm = {
	.name		= "app_l4_clkdm",
	.pwrdm		= { .name = "app_pwrdm" },
	.omap_chip	= OMAP_CHIP_INIT(CHIP_IS_OMAPW3G),
};

static struct clockdomain aud_clkdm = {
	.name		= "aud_clkdm",
	.pwrdm		= { .name = "aud_pwrdm" },
	.omap_chip	= OMAP_CHIP_INIT(CHIP_IS_OMAPW3G),
};
...
static struct clockdomain emu_clkdm = {
	.name		= "emu_clkdm",
	.pwrdm		= { .name = "emu_pwrdm" },
	.clktrctrl_mask = OMAPW3G_CLKTRCTRL_EMU_MASK,
	.omap_chip	= OMAP_CHIP_INIT(CHIP_IS_OMAPW3G),
};
...
static struct clkdm_pwrdm_autodep clkdm_pwrdm_autodeps[] = {
	{
		.pwrdm	   = { .name = "mpu_pwrdm" },
		.omap_chip = OMAP_CHIP_INIT(CHIP_IS_OMAP3430 | CHIP_IS_OMAPW3G)
	},
	{
		.pwrdm	   = { .name = "iva2_pwrdm" },
		.omap_chip = OMAP_CHIP_INIT(CHIP_IS_OMAP3430)
