...
#define OMAP2_MCSPI1_BASE		0x5c190000 /* L3-MODEM*/
#define OMAP2_MCSPI2_BASE		0x47024000 /* L3-APPS*/
#else
			...
			int controller_nr)
{
	...
	if (cpu_is_omapw3g()) {
		if (controller_nr == 0) {
			/* MMC1 */
			omap_cfg_reg(W3G_GPMC_AD20); 	/* SD detect GPIO */
			omap_cfg_reg(W3G_HSMMC1_CLK);
			omap_cfg_reg(W3G_HSMMC1_CMD);
			omap_cfg_reg(W3G_HSMMC1_DAT0);
			omap_cfg_reg(W3G_HSMMC1_DAT1);
			omap_cfg_reg(W3G_HSMMC1_DAT2);
			omap_cfg_reg(W3G_HSMMC1_DAT3);
		}
			/* MMC2: Not required */	
	}
