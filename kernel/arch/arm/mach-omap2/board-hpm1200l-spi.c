/*
 * arch/arm/mach-omap2/board-hpm1200l-spi.c
 *
...
extern struct platform_device cpcap_bt_led;

struct cpcap_spi_init_data hpm1200l_cpcap_spi_init[] = {
	...
	{CPCAP_REG_VHVIOC,    0x0003},
	{CPCAP_REG_VSDIOC,    0x0000},
	{CPCAP_REG_VPLLC,     0x0059},
	{CPCAP_REG_VRF1C,     0x002C},
	{CPCAP_REG_VRF2C,     0x000B},
	{CPCAP_REG_VRFREFC,   0x000B},
	{CPCAP_REG_VWLAN1C,   0x0000},
	...
	{CPCAP_REG_MDLC,      0xFFFB},
	{CPCAP_REG_KLC,       0x0000},
	{CPCAP_REG_BLEDC,     0x0000},
};
...
struct regulator_consumer_supply cpcap_sw5_consumers[] = {
	...
	REGULATOR_CONSUMER("sw5", &cpcap_bt_led.dev),
};
...
extern struct platform_device hpm1200l_dss_device;
#endif
...
static struct cpcap_adc_ato hpm1200l_cpcap_adc_ato = {
	.ato_in = 0x0480,
	.atox_in = 0,
...
static struct cpcap_leds hpm1200l_cpcap_leds = {
	.display_led = {
...
static struct cpcap_platform_data hpm1200l_cpcap_data = {
	.init = hpm1200l_cpcap_spi_init,
	.init_len = ARRAY_SIZE(hpm1200l_cpcap_spi_init),
	...
	.adc_ato = &hpm1200l_cpcap_adc_ato,
	.leds = &hpm1200l_cpcap_leds,
	.ac_changed = NULL,
	.batt_changed = batt_changed,
	.usb_changed = NULL,
};

static struct spi_board_info hpm1200l_spi_board_info[] __initdata = {
	{
		.modalias = "cpcap",
		.bus_num = 2,
		.chip_select = 0,
		.max_speed_hz = 20000000,
		.controller_data = &hpm1200l_cpcap_data,
		.mode = SPI_CS_HIGH,
	},
};

void __init hpm1200l_spi_init(void)
{
	int irq;
	int ret;
	...
	omap_cfg_reg(W3G_GPIO_19);
	omap_cfg_reg(W3G_MCSPI2_NCS0);
	omap_cfg_reg(W3G_MCSPI2_SIMO);
	omap_cfg_reg(W3G_MCSPI2_SOMI);
	omap_cfg_reg(W3G_MCSPI2_CLK);

	hpm1200l_spi_board_info[0].irq = irq;
	spi_register_board_info(hpm1200l_spi_board_info,
				ARRAY_SIZE(hpm1200l_spi_board_info));
