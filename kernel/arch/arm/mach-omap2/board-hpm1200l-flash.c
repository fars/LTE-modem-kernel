/*
 * linux/arch/arm/mach-omap2/board-hpm1200l-flash.c
 *
...
/**
 * hpm1200l_flash_init - Identify devices connected to GPMC and register.
 *
 * @return - void.
 */
void __init hpm1200l_flash_init(void)
{
