...
/* OMAPW3G CM_CLKEN_PLL*.EN_*_DPLL bits - for omap2_get_dpll_rate() */
#define OMAPW3G_EN_DPLL_LPBYPASS		0x5
#define OMAPW3G_EN_DPLL_FRBYPASS		0x6
#define OMAPW3G_EN_DPLL_LOCKED			0x7
