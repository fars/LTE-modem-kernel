/*
 * linux/arch/arm/mach-omap2/board-hpm1200l-camera.c
 *
...
static void hpm1200l_camera_lines_safe_mode(void);
static void hpm1200l_camera_lines_func_mode(void);
...
struct hplens_platform_data hpm1200l_hplens_platform_data = {
...
static int mt9p012_sensor_power_set(struct device *dev, enum v4l2_power power)
{
	...
	case V4L2_POWER_OFF:
		...
		if (regulator != NULL) {
			...
			hpm1200l_camera_lines_safe_mode();
	...
	case V4L2_POWER_ON:
		if (previous_power == V4L2_POWER_OFF) {
			/* Power Up Sequence */
			hpm1200l_camera_lines_func_mode();
...
struct mt9p012_platform_data hpm1200l_mt9p012_platform_data = {
...
void hpm1200l_camera_lines_safe_mode(void)
{
...
void hpm1200l_camera_lines_func_mode(void)
{
...
void __init hpm1200l_camera_init(void)
{
