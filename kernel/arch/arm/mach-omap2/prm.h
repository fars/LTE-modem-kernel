...
/*
 * OMAP2/3/W3G Power/Reset Management (PRM) register definitions
 *
...
#define OMAPW3G_PRM_REGADDR(module, reg)				\
			IO_ADDRESS(OMAPW3G_PRM_BASE + (module) + (reg))
/*
 ...
 *
 */
/* Common registers for 24xx,34xx, and W3G in OCP_MOD */
...
/* Common 34xx and W3G register offsets in OCP_MOD */
#define OMAP3430_PRM_REVISION_OFFSET		0x0004

/* Common 34xx register offsets in OCP_MOD */
...
/* Common 34xx & W3G register offsets in GR_MOD */
...
/* W3G register offsets in GR_MOD */
#define OMAPW3G_PRM_PSCON_PARAM_OFFSET		0x0064
#define OMAPW3G_PRM_DEBUG_OFFSET                0x007C
#define OMAPW3G_PRM_D2DPMCTRL_OFFSET            0x0084
#define OMAPW3G_PRM_D2DPMST_OFFSET              0x0088

/* 34xx register offset in CCR_MOD */
#define OMAP3_PRM_CLKSEL_OFFSET			0x0040

/* Common 34xx and W3G  register offset in CCR_MOD */
 ...
 *
 * With a few exceptions, these are the register names beginning with
 * {PM,RM}_* on all three architectures.  (The exceptions are the IRQSTATUS
 * and IRQENABLE bits.)
 *
 */
...
/* W3G specific registers */
#define OMAPW3G_PM_MPUGRPSEL				0x0060
#define OMAPW3G_PM_DSPGRPSEL				0x0070

#define OMAPW3G_PRM_IRQSTATUS_DSP			0x00f8
#define OMAPW3G_PRM_IRQENABLE_DSP			0x00fc
...
/* Wrigley call RST_GS 'GLOBAL_WARM_SW_RST', and 
 * DPLL3 'GLOBAL_COLD_SW_RST' */
 ...
 *	 PM_PWSTST_NEON
 * W3G:  PM_PWSTST_MPU, PM_PWSTST_CORE, PM_PWSTST_APP, PM_PWSTST_CUST_EFUSE,
 *	 PM_PWSTST_DSS, PM_PWSTST_CAM, PM_PWSTST_WCDMA, PM_PWSTST_EMU,
 *   PM_PWSTST_R5R6, PM_PWSTST_AUD
 */
 ...
 *	 PM_PWSTST_DSS, PM_PWSTST_CAM, PM_PWSTST_PER, PM_PWSTST_EMU,
 *	 PM_PWSTST_NEON
 *  W3G: PM_PWSTST_DSP, PM_PWSTST_MPU, PM_PWSTST_CORE,PM_PWSTST_APP,
 *       PM_PWSTST_WCDMA, PM_PWSTST_R5R6, PM_PWSTST_AUD, PM_PWSTST_CUST_EFUSE
 *       PM_PWSTST_CAM, PM_PWSTST_DSS
 */
 ...
 *
 *  W3G: PM_RSTST_DSP, PM_RSTST_MPU, PM_RSTST_CORE, PM_RSTST_APP,
 *       PM_RSTST_WCDMA, PM_RSTST_R5R6, PM_RSTST_AUD, PM_RSTST_CUST_EFUSE
 *       PM_RSTST_CAM, PM_RSTST_DSS, PM_RSTST_EMU
 */
 ...
 *
 *  W3G: PM_RSTST_DSP, PM_RSTST_MPU, PM_RSTST_CORE, PM_RSTST_APP,
 *       PM_RSTST_WCDMA, PM_RSTST_R5R6, PM_RSTST_AUD, 
 *       PM_RSTST_CAM, PM_RSTST_DSS, PM_RSTST_EMU
 *       PM_RSTST_CUST_EFUSE only has GLOBALCOLD_RST
 */
 ...
 *	 PM_PWSTCTRL_NEON
 *
 *  W3G: PM_PWSTCTRL_DSP, PM_PWSTCTRL_MPU, PM_PWSTCTRL_CORE, PM_PWSTCTRL_APP,
 *       PM_PWSTCTRL_WCDMA, PM_RPWSTCTRL_R5R6, PM_PWSTCTRL_AUD,  
 */
 ...
 *  W3G: PM_PWSTCTRL_DSP, PM_PWSTCTRL_MPU, PM_PWSTCTRL_CORE, PM_PWSTCTRL_APP,
 *       PM_PWSTCTRL_WCDMA, PM_RPWSTCTRL_R5R6, PM_PWSTCTRL_AUD,  
 *       PM_PWSTCTRL_CAM, PM_PWSTCTRL_DSS,, PM_PWSTCTRL_CUST_EFUSE,
 *       PM_PWSTCTRL_EMU
 */
