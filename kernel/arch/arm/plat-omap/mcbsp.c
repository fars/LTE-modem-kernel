...
static void omap_mcbsp_dump_reg(u8 id)
{
	...
	if (cpu_is_omapw3g() || cpu_is_omap34xx() || cpu_is_omap2430()) {
...
void omap_mcbsp_config(unsigned int id, const struct omap_mcbsp_reg_cfg *config)
{
	...
	if (cpu_is_omapw3g() || cpu_is_omap2430() || cpu_is_omap34xx()) {
...
int omap_mcbsp_request(unsigned int id)
{
	...
	if (cpu_is_omap34xx() || cpu_is_omapw3g()) {
		...
		if (cpu_is_omapw3g())
			w |= CLOCKACTIVITY(0x01);
		else
			w |= CLOCKACTIVITY(0x02);
...
void omap_mcbsp_free(unsigned int id)
{
	 ...
	 */
	if (cpu_is_omapw3g() || cpu_is_omap34xx()) {
		u16 w;
