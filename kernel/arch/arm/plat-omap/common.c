...
static struct omap_globals w3g_globals = {
	.class	= OMAP242X_CLASS,
	.tap	= OMAP2_IO_ADDRESS(0x5C182300),
	.sdrc	= OMAP2_IO_ADDRESS(OMAPW3G_SDRC_BASE),
	.sms	= OMAP2_IO_ADDRESS(NULL),
	.ctrl	= OMAP2_IO_ADDRESS(OMAPW3G_CTRL_BASE),
	.prm	= OMAP2_IO_ADDRESS(OMAPW3G_PRM_BASE),
	.cm	= OMAP2_IO_ADDRESS(OMAPW3G_CM_BASE),
};

void __init omap2_set_globals_w3g(void)
{
	omap2_globals = &w3g_globals;
	__omap2_set_globals();
}
#endif
