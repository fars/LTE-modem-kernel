 ...
 */
  ...
  * Date         Author          Comment
  * ===========  ==============  ==============================================
  * 15-Dec-2009  Motorola        Add support of linked list type 3 SD for W3G
  * 18-Dec-2009  Motorola        Add burst mode for W3G
  * 25-Jun-2010  Motorola        Add defines for linked list support for W3G
*/
...
#define OMAP_W3G_DMA4_BASE      (L3_W3G_BASE + 0x0100A000)
...
#define OMAP_DMA4_LOGICAL_DMA_CH_COUNT	24
#else
...
#define OMAPW3G_DMA_D2D_REQ0		17	/* S_DMA_16 */
#define OMAPW3G_DMA_D2D_REQ1		18	/* S_DMA_17 */
...
/* DMA channels specific to W3G */
#define OMAPW3G_DMA_D2D_REQ0		17	/* S_DMA_16 */
#define OMAPW3G_DMA_D2D_REQ1		18	/* S_DMA_17 */
#define OMAPW3G_DMA_L1T_2G_TRIGS0	21	/* S_DMA_20 */
#define OMAPW3G_DMA_L1T_2G_TRIGS1	22	/* S_DMA_21 */
#define OMAPW3G_DMA_L1T_2G_TRIGS2	23	/* S_DMA_22 */
#define OMAPW3G_DMA_L1T_3G_TRIGS0	24	/* S_DMA_23 */
#define OMAPW3G_DMA_L1T_3G_TRIGS1	25	/* S_DMA_24 */
#define OMAPW3G_DMA_L1T_3G_TRIGS2	26	/* S_DMA_25 */
#define OMAPW3G_DMA_USIM_TX		55	/* S_DMA_54 */
#define OMAPW3G_DMA_USIM_RX		56	/* S_DMA_55 */
...
/* linked  lists params*/
#define OMAP_DMA_CDP_LINKED_LIST_DESCR_BIG_ENDIAN    0x8000
#define OMAP_DMA_CDP_LINKED_LIST_DESCR_LITTLE_ENDIAN 0x0000
#define OMAP_DMA_CDP_LINKED_LIST_ENABLE_FAST_MODE    0x400
#define OMAP_DMA_CDP_LINKED_LIST_TRANSFER_MODE       0x100
#define OMAP_DMA_CDP_LINKED_LIST_DESCR_TYPE_1        0x10
#define OMAP_DMA_CDP_LINKED_LIST_DESCR_TYPE_2        0x20
#define OMAP_DMA_CDP_LINKED_LIST_DESCR_TYPE_3        0x30
#define OMAP_DMA_CDP_LINKED_LIST_SRC_ADDRESS_INCR    0x0
#define OMAP_DMA_CDP_LINKED_LIST_SRC_ADDRESS_LOAD    0x4
#define OMAP_DMA_CDP_LINKED_LIST_SRC_ADDRESS_CONST   0x8
#define OMAP_DMA_CDP_LINKED_LIST_DEST_ADDRESS_INCR   0x0
#define OMAP_DMA_CDP_LINKED_LIST_DEST_ADDRESS_LOAD   0x1
#define OMAP_DMA_CDP_LINKED_LIST_DEST_ADDRESS_CONST  0x2
...
/* Burst mode types*/
/* Be careful this enum doesn't fit the values set in the sDMA register, this is just a type*/
enum omap_dma_burst_mode {
	OMAP_DMA_DATA_BURST_DIS = 0,
	OMAP_DMA_DATA_BURST_4,
	OMAP_DMA_DATA_BURST_8,
	OMAP_DMA_DATA_BURST_16,
	OMAP_DMA_DATA_BURST_32,
	OMAP_DMA_DATA_BURST_64
};
...
enum prefetch_mode {
        OMAP_DMA_PREFETCH_DIS = 0,
	OMAP_DMA_PREFETCH_EN
};
...
extern void omap_set_dma_prefetch_mode(int lch, enum prefetch_mode prefetch);
...
extern void omap_set_linked_list_dma_descr_type3sd(int lch, unsigned long desc_params , unsigned long desc_adr);
