...
#define DPLL_IDLE_BYPASS_FAST_RELOCK    0x6
#endif
...
#define MPU_IMASK		0x1
#define CORE2_IMASK		0x0
#define CORE1_IMASK		0x10030
#define	CORE3_IMASK		0x0
#define CFUSE_IMASK		0x0 /*CUST EFUSE on Wrigley*/
#define	USBHOST_IMASK	0x0 /* R5R6 on Wrigley */
#define WKUP_IMASK		0x0
#define DSS_IMASK		0x1
#define CAM_IMASK		0x1
#define PER_IMASK		0x200 /* APPS on Wrigley*/
#define NEON_IMASK		0x0 /*WCDMA on Wrigley*/
#define AUD_IMASK		0x0
#endif
...
#else
/* DEVICE ID's */
/* Devices in Core1 registers *//*CORE on wrigley is core1 here*/

#define PRCM_MCBSP2	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV | ID_CLK_SRC)) |\
				ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)|\
				ID_CLK_SRC_BIT_POS(0x6) | ID_DEV_BIT_POS(0x0) )

#define PRCM_UART1	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
				ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
				| ID_DEV_BIT_POS(0x1) )

#define PRCM_UART2	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
				ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
				| ID_DEV_BIT_POS(0x2) )

#define PRCM_UART3	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
					ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
					| ID_DEV_BIT_POS(0x3) )
	
#define PRCM_HSOTG	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
					ID_DEV_TYPE(INITIATOR) | ID_DOMAIN(DOM_CORE1)\
					| ID_DEV_BIT_POS(0x4) )

#define PRCM_FSOTG	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
					ID_DEV_TYPE(INITIATOR) | ID_DOMAIN(DOM_CORE1)\
					| ID_DEV_BIT_POS(0x5) )

#define PRCM_MCSPI1	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
					ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
					| ID_DEV_BIT_POS(0x6) )

#define PRCM_SDRC	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
				| ID_DEV_BIT_POS(0x7))

#define PRCM_MMC1	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0x8) )

#define PRCM_MMC2	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0x9) )

#define PRCM_USIM	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV | ID_CLK_DIV | ID_CLK_SRC)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_CLK_SRC_BIT_POS(0xA) | ID_DEV_BIT_POS(0xA) | ID_CLK_NO(0xA) )
							
#define PRCM_2GL1T	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0xB) )
						
#define PRCM_I2C1	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0xD) )


#define PRCM_I2C1_FCLK	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0xD) )

#define PRCM_I2C1_ICLK	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0xC) )


#define PRCM_OMAP_CTRL	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0xD) )

#define PRCM_D2D	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0xE) )

#define PRCM_MODEM_CIPHER	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0xF) )

#define PRCM_MDMA	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(INITIATOR) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0x10) )


#define PRCM_ELM	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0x11) )


#define PRCM_SDIO_SLV	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0x12) )

#define PRCM_RCI	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0x13) )

#define PRCM_DBG	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV)) |\
						ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_CORE1)\
						| ID_DEV_BIT_POS(0x14) )

#define PRCM_CORE1_CONSTRAINT	(ID_OMAP(AT_3430) | \
				OTHER_ID_TYPE(ID_CONSTRAINT_CLK) | \
				ID_DOMAIN(DOM_CORE1))/*pending*/


/* Devices in WKUP registers*/

/* GPT1 is DMTimer1 in W3G*/
#define PRCM_GPT1	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV | ID_CLK_SRC))\
				| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_WKUP) | \
				ID_CLK_SRC_BIT_POS(0x0) | ID_DEV_BIT_POS(0x0))

#define PRCM_32KSYNC	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_WKUP) | ID_DEV_BIT_POS(0x2))

#define PRCM_GPIO1	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_WKUP) | ID_DEV_BIT_POS(0x3))
				
#define PRCM_WDT1	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_WKUP) | ID_DEV_BIT_POS(0x4))

#define PRCM_WDT2	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_WKUP) | ID_DEV_BIT_POS(0x5))

#define PRCM_KBC	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_WKUP) | ID_DEV_BIT_POS(0xA))

#define PRCM_2GDSM	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_WKUP) | ID_DEV_BIT_POS(0xB))

#define PRCM_3GDSM	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_WKUP) | ID_DEV_BIT_POS(0xC))

#define PRCM_SR1	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_WKUP) | ID_DEV_BIT_POS(0xD))

#define PRCM_SR2	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_WKUP) | ID_DEV_BIT_POS(0xE))
...
#define PRCM_IVA2	(ID_OMAP(AT_3430) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(INIT_TAR)\
				| ID_DOMAIN(DOM_IVA2) | ID_DEV_BIT_POS(0x1))/* dev bit pos is 0 in case of 3430*/
#endif

#define PRCM_IVA2_CONSTRAINT	(ID_OMAP(AT_3430) | \
				 OTHER_ID_TYPE(ID_CONSTRAINT_CLK) | \
				 ID_DOMAIN(DOM_IVA2))/* pending need to find wat is constraint clk*/

/* Devices in DSS registers */
#define PRCM_DSS	(ID_OMAP(AT_3430) | ID_TYPE((ID_DEV | ID_DPLL_OP)) |\
				ID_DEV_TYPE(INITIATOR)\
				| ID_DOMAIN(DOM_DSS) | ID_DEV_BIT_POS(0x0) | \
				ID_DPLL_DIV(DPLL_M4X2) | ID_DPLL_NO(DPLL4_PER))/* pending need to see dplls setting*/
...
/* need to see why below 3 are needed*/
#define PRCM_DISPC	(ID_OMAP(AT_3430) | OTHER_ID_TYPE(ID_SYSCONF) |\
				ID_DEV_TYPE(INIT_TAR) \
				| ID_DOMAIN(DOM_DSS) | ID_DEV_BIT_POS(0x1))
...
#define PRCM_GPT3	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV | ID_CLK_SRC))\
				| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_PER) | \
				ID_CLK_SRC_BIT_POS(0x0) | ID_DEV_BIT_POS(0x0))

#define PRCM_MCSPI2	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV ))\
					| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_PER) | \
					ID_DEV_BIT_POS(0x1))

#define PRCM_HDQ	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV ))\
						| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_PER) | \
						ID_DEV_BIT_POS(0x2))

#define PRCM_MBOXES	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV ))\
						| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_PER) | \
						ID_DEV_BIT_POS(0x3))

#define PRCM_AES	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV ))\
						| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_PER) | \
						ID_DEV_BIT_POS(0x4))

#define PRCM_DES3DES	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV ))\
						| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_PER) | \
						ID_DEV_BIT_POS(0x5))

#define PRCM_PKA	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV ))\
						| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_PER) | \
						ID_DEV_BIT_POS(0x6))

#define PRCM_RNG	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV ))\
						| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_PER) | \
						ID_DEV_BIT_POS(0x7))

#define PRCM_SHA2	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV ))\
						| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_PER) | \
						ID_DEV_BIT_POS(0x8))
...
/* AUD domain*/
#define PRCM_MCBSP1	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV | ID_CLK_SRC))\
				| ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_AUD) | \
				ID_CLK_SRC_BIT_POS(0x1) | ID_DEV_BIT_POS(0x3))

#define PRCM_GPT2	(ID_OMAP(AT_W3G) | ID_TYPE((ID_DEV | ID_CLK_SRC))\
					| ID_DEV_TYPE(TARGET) | ID_DOMAIN(DOM_AUD) | \
					ID_CLK_SRC_BIT_POS(0x0) | ID_DEV_BIT_POS(0x2))

#define PRCM_GPIO2	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_AUD) | ID_DEV_BIT_POS(0x0))

#define PRCM_GPIO3	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_AUD) | ID_DEV_BIT_POS(0x1))

/*CUST_EFUSE domain*/
#define PRCM_CPEFUSE	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DEV) |\
				ID_DEV_TYPE(TARGET)\
				| ID_DOMAIN(DOM_CFUSE) | ID_DEV_BIT_POS(0x0))
...
/* DPLL ID's */
#if defined(CONFIG_ARCH_OMAPW3G)
#define PRCM_DPLL1_M2_CLK	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DPLL_OP)\
					| ID_DPLL_DIV(DPLL_M2) |\
					ID_DPLL_NO(DPLL1_MPU))

#else

#define PRCM_DPLL1_M2X2_CLK	(ID_OMAP(AT_W3G) | ID_TYPE(ID_DPLL_OP)\
...
#if defined(CONFIG_ARCH_OMAPW3G)
#define PRCM_DPLL4_M2_CLK	(ID_OMAP(AT_3430) | ID_TYPE(ID_DPLL_OP)\
				       | ID_DPLL_DIV(DPLL_M2) |\
					ID_DPLL_NO(DPLL4_PER))
...
/* CLK ID's */
#if defined(CONFIG_ARCH_OMAPW3G)
/* in 3430 core clk is same as dpll4_m2_clk..in W3G core clock is divide by1 or divide by2
of dpll4_m2_clk*/
#define PRCM_CORE_CLK 		(ID_OMAP(AT_W3G) | ID_TYPE(ID_CLK_DIV | ID_DPLL_OP) |\
                            ID_CLK_NO(0x4) | ID_DPLL_DIV(DPLL_M2) \
                            | ID_DPLL_NO(DPLL3_CORE))
#endif
...
#if defined(CONFIG_ARCH_OMAPW3G)
/* In wrigley no source sel for 96M clock*/
#define PRCM_96M_CLK		(ID_OMAP(AT_3430_ES2))
...
#if defined(CONFIG_ARCH_OMAPW3G)
/* In wrigley no source sel for 48M clock*/

#define PRCM_48M_FCLK 		(ID_OMAP(AT_W3G) | ID_TYPE((ID_CLK_DIV))\
	                          | ID_CLK_NO(0xB))
#define PRCM_CLKOUT2_SRC_CLK	(OMAP(AT_W3G) | OTHER_ID_TYPE(ID_CLK_PARENT))
...
#define PRCM_VDD2_OPP3		(OMAP(AT_3430) | OTHER_ID_TYPE(ID_OPP) |\
					...
					| ID_OPP_NO(0x3))
#if defined(CONFIG_ARCH_OMAPW3G)
#define PRCM_VDD2_OPP4		(OMAP(AT_W3G) | OTHER_ID_TYPE(ID_OPP) |\
					ID_VDD(PRCM_VDD2)\
					| ID_OPP_NO(0x4))
#endif
...
#ifdef CONFIG_MOT_FEAT_PMIC_CPCAP
/* PRM_VC_CMD_VAL_0 specific bits */
#define PRM_VC_CMD_VAL0_ON		0x68
#define PRM_VC_CMD_VAL0_ONLP		0x08
#define PRM_VC_CMD_VAL0_RET		0x18
#define PRM_VC_CMD_VAL0_OFF		0x00

/* PRM_VC_CMD_VAL_1 specific bits */
#define PRM_VC_CMD_VAL1_ON		0x68
#define PRM_VC_CMD_VAL1_ONLP		0x08
...
#ifdef CONFIG_MOT_FEAT_PMIC_CPCAP
#define PRM_VC_CH_CONF_RACEN0		(0x1 << 3)
#define PRM_VC_CH_CONF_SA1		(0x1 << 16)
#define PRM_VC_CH_CONF_RACEN1		(0x1 << 19)
#endif

/* PRM_VC_I2C_CFG */
#ifdef CONFIG_MOT_FEAT_PMIC_CPCAP	/* For CPCAP */
#define PRM_VC_I2C_CFG_MCODE		0x8
#else	/* For Triton2 */
...
#ifdef CONFIG_MOT_FEAT_PMIC_CPCAP
#define R_SRI2C_SLAVE_ADDR_SA0		0x1	/* SMPS I2C Address for VDD1 */
#define R_SRI2C_SLAVE_ADDR_SA1		0x2	/* SMPS I2C Address for VDD2 */
#define R_SMPS_VOL_CNTL_RA0		0x00	/* SMPS I2C voltage control register Address for VDD1 */
#define R_SMPS_VOL_CNTL_RA1		0x00	/* SMPS I2C voltage control register Address for VDD2 */
#define R_SMPS_VOL_CNTL_CMDRA0		0x01	/* SMPS I2C voltage control register Address for VDD1, used for SR command */
#define R_SMPS_VOL_CNTL_CMDRA1		0x01	/* SMPS I2C voltage control register Address for VDD2, used for SR command */
...
#define CPCAP_SMPS_UPDATE_DELAY		40	/* In uSec */
#endif
...
#else
       PRCM_SLEEP_SAVE_CONTROL_PADCONF_SYS_CLKOUT2,
#endif
...
#else
    PRCM_SLEEP_SAVE_CM_FCLKEN_AUD,
    PRCM_SLEEP_SAVE_CM_FCLKEN_NEON,
#endif
...
#else
    PRCM_SLEEP_SAVE_CM_ICLKEN_AUD,
    PRCM_SLEEP_SAVE_CM_ICLKEN_NEON,
#endif
...
#if defined(CONFIG_ARCH_OMAPW3G)
    PRCM_SLEEP_SAVE_CM_CLKSTCTRL_AUD,
#endif
...
#else
    PRCM_SLEEP_SAVE_CM_AUTOIDLE_AUD,
...
#else
    PRCM_SLEEP_SAVE_CM_SLEEPDEP_AUD,
#endif
...
#else
	PRCM_SLEEP_SAVE_PM_MPUGRPSEL_AUD,
	PRCM_SLEEP_SAVE_PM_DSPGRPSEL_AUD,
#endif
...
#if defined(CONFIG_ARCH_OMAPW3G)
extern int prcm_set_app_domain_state(u32 core_dom_state);
#endif
