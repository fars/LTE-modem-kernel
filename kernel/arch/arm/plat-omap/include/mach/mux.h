...
/* 24xx/34xx/w3g mux bit defines */
#define OMAP2_PULL_ENA		(1 << 3)
#define OMAP2_PULL_UP		(1 << 4)
#define OMAP2_ALTELECTRICALSEL	(1 << 5)

/* 34xx/w3g specific mux bit defines */
...
/* W3G mux mode options for each pin. See TRM for options */
#define	OMAPW3G_MUX_MODE0	0
#define	OMAPW3G_MUX_MODE1	1
#define	OMAPW3G_MUX_MODE2	2
#define	OMAPW3G_MUX_MODE3	3

/* W3G active pin states */
#define OMAPW3G_PIN_OUTPUT		0
#define OMAPW3G_PIN_INPUT		OMAP3_INPUT_EN
#define OMAPW3G_PIN_INPUT_PULLUP	(OMAP2_PULL_ENA | OMAP3_INPUT_EN \
						| OMAP2_PULL_UP)
#define OMAPW3G_PIN_INPUT_PULLDOWN	(OMAP2_PULL_ENA | OMAP3_INPUT_EN)

/* W3G off mode states */
#define OMAPW3G_PIN_OFF_NONE           0
#define OMAPW3G_PIN_OFF_OUTPUT_HIGH	(OMAP3_OFF_EN | OMAP3_OFFOUT_VAL)
#define OMAPW3G_PIN_OFF_OUTPUT_LOW	(OMAP3_OFF_EN)
#define OMAPW3G_PIN_OFF_INPUT_PULLUP	(OMAP3_OFF_EN | OMAP3_OFFIN_EN \
						| OMAP3_OFF_PULL_EN \
						| OMAP3_OFF_PULL_UP)
#define OMAPW3G_PIN_OFF_INPUT_PULLDOWN	(OMAP3_OFF_EN | OMAP3_OFFIN_EN \
						| OMAP3_OFF_PULL_EN)
#define OMAPW3G_PIN_OFF_WAKEUPENABLE	OMAP3_WAKEUP_EN

#define MUX_CFG_W3G(desc, reg_offset, mux_value) {		\
	.name		= desc,					\
	.debug		= 0,					\
	.mux_reg	= reg_offset,				\
	.mux_val	= mux_value				\
